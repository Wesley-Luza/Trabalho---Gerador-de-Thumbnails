...
# EXTRA:
Deixo compartilhado em anexo também, uma versão do trabalho em python, que executa um aplicativo com a mesma finalidade do trabalho feito em linguagem C.
